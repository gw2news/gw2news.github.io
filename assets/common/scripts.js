...
function enableSwiper(){
	...
	if ( isExists(':host::ng-deep.swiper-container') ) {
		
		$(':host::ng-deep.swiper-container').each(function (index) {
			...
			var swiperDirection 			= $(this).data('swiper-direction'),
				...
				swiperScrollbar 			= ($(this).data('scrollbar') ? $(this).parentsUntil(':host::ng-deep.swiper-area').find(':host::ng-deep.swiper-scrollbar') : null);
				//swiperScrollbar 			= ($(this).data('scrollbar') ? $(this).find(':host::ng-deep.swiper-scrollbar') : null);
			...
			var swiper = new Swiper($(this)[0], {
				...
				pagination			: $(this).find(':host::ng-deep.swiper-pagination'),
				...
				nextButton			: ':host::ng-deep.swiper-button-next',
				prevButton			: ':host::ng-deep.swiper-button-prev',
			...
			$(':host::ng-deep.swiper-container').hover(function(){
				swiper.stopAutoplay();
			}, function(){
